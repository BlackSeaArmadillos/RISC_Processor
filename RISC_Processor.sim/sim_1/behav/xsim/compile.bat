...
REM
REM Generated by Vivado on Wed Jul 20 19:52:04 +0300 2022
...
echo "xvlog --incr --relax -prj risc_processor_tb_vlog.prj"
call xvlog  --incr --relax -prj risc_processor_tb_vlog.prj -log xvlog.log
